...
private:
    ...
    static const TPrintPvFuncPointer lfuncPrintPvFunctionTable[_iSizeBasicDbrTypes];
    
    typedef int ( EpicsMonitorPv::* TWriteXtcValueFuncPointer ) ( char*& pcXtcMem, int& iSizeXtc ) const;
    static const TWriteXtcValueFuncPointer lfuncWriteXtcTimeValueFunctionTable[_iSizeBasicDbrTypes];
    static const TWriteXtcValueFuncPointer lfuncWriteXtcCtrlValueFunctionTable[_iSizeBasicDbrTypes];    
};
