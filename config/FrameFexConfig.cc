...
namespace Pds_ConfigDb {
  ...
  public:
    Private_Data() :
      ...
      _roi_begin_col    ("ROI Begin Column", 0, 0, 0x7fff),
      _roi_begin_row    ("ROI Begin Row"   , 0, 0, 0x7fff),
      _roi_end_col      ("ROI   End Column", 0, 0, 0x7fff),
      _roi_end_row      ("ROI   End Row"   , 0, 0, 0x7fff),
