...
class Pds_ConfigDb::JungfrauConfig_V3::Private_Data : public Parameter {
 ...
 public:
  ...
  ~Private_Data();
   ...
   int push( void* to );
   int dataSize() const
      { return sizeof(Pds::Jungfrau::ConfigV3); }
   void flush ()
  ...
  Enumerated<Pds::Jungfrau::ConfigV3::GainMode> _gainMode;
  Enumerated<Pds::Jungfrau::ConfigV3::SpeedMode> _speedMode;
  ...
  Pds::Jungfrau::ModuleConfigV1 _module_config[Pds::Jungfrau::ConfigV3::MaxModulesPerDetector];
};

const char* Pds_ConfigDb::JungfrauConfig_V3::Private_Data::lsEnumGainMode[] = { "Normal", "FixedGain1", "FixedGain2", "ForcedGain1", "ForcedGain2", "HighGain0", NULL};
const char* Pds_ConfigDb::JungfrauConfig_V3::Private_Data::lsEnumSpeedMode[] = { "Quarter", "Half", NULL};

Pds_ConfigDb::JungfrauConfig_V3::Private_Data::Private_Data(bool expert_mode) :
  _expert_mode              (expert_mode),
  _numberOfModules          ("Number of Modules",         1,    1,      Pds::Jungfrau::ConfigV3::MaxModulesPerDetector),
  _numberOfRowsPerModule    ("Number of Rows",            512,  1,      Pds::Jungfrau::ConfigV3::MaxRowsPerModule),
  _numberOfColumnsPerModule ("Number of Columns",         1024, 1,      Pds::Jungfrau::ConfigV3::MaxColumnsPerModule),
  _biasVoltage              ("Bias Voltage (V)",          200,  0,      500),
  _gainMode                 ("Gain Mode",                 Pds::Jungfrau::ConfigV3::Normal, lsEnumGainMode),
  _speedMode                ("Speed Mode",                Pds::Jungfrau::ConfigV3::Quarter, lsEnumSpeedMode),
...
{
  for (unsigned i=0; i<Pds::Jungfrau::ConfigV3::MaxModulesPerDetector; i++) {
    _module_config[i] = Pds::Jungfrau::ModuleConfigV1(0,0,0);
  }
...
Pds_ConfigDb::JungfrauConfig_V3::Private_Data::~Private_Data() 
{}

QLayout* Pds_ConfigDb::JungfrauConfig_V3::Private_Data::initialize(QWidget* p)
{
...
int Pds_ConfigDb::JungfrauConfig_V3::Private_Data::pull( void* from )
{
  Pds::Jungfrau::ConfigV3& cfg = * new (from) Pds::Jungfrau::ConfigV3;
  ...
  _gainMode.value                 = (Pds::Jungfrau::ConfigV3::GainMode) cfg.gainMode();
  _speedMode.value                = (Pds::Jungfrau::ConfigV3::SpeedMode) cfg.speedMode();
...
int Pds_ConfigDb::JungfrauConfig_V3::Private_Data::push(void* to)
{
  new (to) Pds::Jungfrau::ConfigV3(
...
Pds_ConfigDb::JungfrauConfig_V3::JungfrauConfig_V3(bool expert_mode) :
  Serializer("JungfrauConfig_V3"),
  _private_data( new Private_Data(expert_mode) )
{
  pList.insert(_private_data);
}

int Pds_ConfigDb::JungfrauConfig_V3::readParameters (void* from)
{
  return _private_data->pull(from);
}

int Pds_ConfigDb::JungfrauConfig_V3::writeParameters(void* to)
{
  return _private_data->push(to);
}

int Pds_ConfigDb::JungfrauConfig_V3::dataSize() const
{
