...
namespace Pds_ConfigDb {
  ...
  public:
    Private_Data() :
      ...
      _dac0ThlFine    ("DAC0 thl fine",     TIMEPIX_DAC_THLFINE_DEFAULT,    0, 255),
      _dac0ThlCourse  ("DAC0 thl course",   TIMEPIX_DAC_THLCOURSE_DEFAULT,  0, 255),
      ...
      _dac1ThlFine    ("DAC1 thl fine",     TIMEPIX_DAC_THLFINE_DEFAULT,    0, 255),
      _dac1ThlCourse  ("DAC1 thl course",   TIMEPIX_DAC_THLCOURSE_DEFAULT,  0, 255),
      ...
      _dac2ThlFine    ("DAC2 thl fine",     TIMEPIX_DAC_THLFINE_DEFAULT,    0, 255),
      _dac2ThlCourse  ("DAC2 thl course",   TIMEPIX_DAC_THLCOURSE_DEFAULT,  0, 255),
      ...
      _dac3ThlFine    ("DAC3 thl fine",     TIMEPIX_DAC_THLFINE_DEFAULT,    0, 255),
      _dac3ThlCourse  ("DAC3 thl course",   TIMEPIX_DAC_THLCOURSE_DEFAULT,  0, 255),
...
//    tc.dump();
    ...
    int dataSize() const {
      return sizeof(TimepixConfigType);
    }
...
int  TimepixConfig::readParameters (void* from) {
  return _private_data->pull(from);
}

int  TimepixConfig::writeParameters(void* to) {
  return _private_data->push(to);
}

int  TimepixConfig::dataSize() const {
