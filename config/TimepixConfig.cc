...
// ---------- expert mode ------------
TimepixExpertConfig::TimepixExpertConfig() :
...
int  TimepixExpertConfig::readParameters (void* from) {
  return _private_data->pull(from);
}

int  TimepixExpertConfig::writeParameters(void* to) {
  return _private_data->push(to);
}

int  TimepixExpertConfig::dataSize() const {
