  ...
  namespace V3 {
    ...
    class GlobalP {
      ...
      public:
        ...
        void pull   (const Pds::CsPad::ConfigV3& p)
        {
        ...
        void push   (Pds::CsPad::ConfigV3* p)
        {
          ...
          *new (p) Pds::CsPad::ConfigV3( _runDelay .value,
              _eventCode.value,
      ...
      public:
        void initialize(QWidget* parent, QVBoxLayout* layout)
        {
          ...
          _qlink = new CspadConfigTableQ_V3(*this,parent);
...
using namespace Pds_ConfigDb::V3;
using Pds_ConfigDb::CspadConfigTable_V3;
using Pds_ConfigDb::CspadConfig_V3;
using Pds_ConfigDb::CspadConfigTableQ_V3;


CspadConfigTable_V3::CspadConfigTable_V3(const CspadConfig_V3& c) :
          Parameter(NULL),
          _cfg(c)
{
...
CspadConfigTable_V3::~CspadConfigTable_V3()
{
}

void CspadConfigTable_V3::insert(Pds::LinkedList<Parameter>& pList)
{
  pList.insert(this);
...
int CspadConfigTable_V3::pull(const void* from) {
  const Pds::CsPad::ConfigV3& tc = *reinterpret_cast<const Pds::CsPad::ConfigV3*>(from);
...
int CspadConfigTable_V3::push(void* to) const {

  Pds::CsPad::ConfigV3& tc = *reinterpret_cast<Pds::CsPad::ConfigV3*>(to);
  _globalP->push(&tc);
  for(unsigned q=0; q<4; q++)
...
int CspadConfigTable_V3::dataSize() const {
  return sizeof(Pds::CsPad::ConfigV3);
}

bool CspadConfigTable_V3::validate()
{
...
QLayout* CspadConfigTable_V3::initialize(QWidget* parent)
{
...
void CspadConfigTable_V3::update() {
...
void CspadConfigTable_V3::flush () {
  Parameter* p = _pList.forward();
  while( p != _pList.empty() ) {
    p->flush();
    p = p->forward();
...
void CspadConfigTable_V3::enable(bool)
{
}

CspadConfigTableQ_V3::CspadConfigTableQ_V3(V3::GlobalP& table,
    QWidget* parent) :
    QObject(parent),
    _table (table)
{
...
void CspadConfigTableQ_V3::update_readout() { _table.update_readout(); }
