#ifndef PdsApp_Configdb_Epix10kaQuad_V1_hh
#define PdsApp_Configdb_Epix10kaQuad_V1_hh
  ...
  namespace V1 {
    namespace Epix10kaQuad {
      ...
      public:
        void enable(bool v);
        void reset ();
        void pull   (const Epix10kaQuadConfigV1& p);
        void push   (Epix10kaQuadConfigV1* p);
      public:
