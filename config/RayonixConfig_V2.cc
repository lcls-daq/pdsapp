...
namespace Pds_ConfigDb {
  ...
  static const char* res_to_name[] = { "3840x3840 (binning 1x1)",
  ...
  // ------- expert mode ---------
  class RayonixExpertConfig_V2::Private_Data {
  public:
    ...
    Private_Data() :
      _readoutMode    ("Readout mode", Pds::Rayonix::ConfigV2::Standard, readoutMode_to_name),
  ...
  // ------- user mode ---------
  class RayonixConfig_V2::Private_Data {
  public:
...
// ---------- expert mode ------------
RayonixExpertConfig_V2::RayonixExpertConfig_V2() :
...
int  RayonixExpertConfig_V2::readParameters (void* from) {
  return _private_data->pull(from);
}

int  RayonixExpertConfig_V2::writeParameters(void* to) {
  return _private_data->push(to);
}

int  RayonixExpertConfig_V2::dataSize() const {
  return _private_data->dataSize();
}

// ---------- user mode ------------
RayonixConfig_V2::RayonixConfig_V2() :
...
int  RayonixConfig_V2::readParameters (void* from) {
  return _private_data->pull(from);
}

int  RayonixConfig_V2::writeParameters(void* to) {
  return _private_data->push(to);
}

int  RayonixConfig_V2::dataSize() const {
  return _private_data->dataSize();
}
