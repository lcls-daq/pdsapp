...
$dbexe --create $dbroot
$dbexe --create-device $dbroot IMS 07cc0031 07cc0030
$dbexe --create-device-alias $dbroot IMS CALIB1
$dbexe --copy-device-alias $dbroot IMS CALIB2 CALIB1
$dbexe --import-device-data $dbroot IMS 00000007 configdb/02/lab1/data/opal1k_12b_20g.dat "Opal config BL=12 GN=20"
$dbexe --assign-device-alias $dbroot IMS CALIB1 00000007 opal1k_12b_20g.dat
