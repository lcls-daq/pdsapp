  ...
  namespace V1 {
    namespace Epix10ka2M {
      ...
      public:
        ...
        int  pull  (const Pds::Epix::Config10ka2MV1& tc);
      ...
      public:
        ...
        void pull   (const Pds::Epix::Config10ka2MV1& p)
        {
        ...
        void push   (Pds::Epix::Config10ka2MV1* p)
        {
          ...
          __attribute__((unused)) Pds::Epix::Config10ka2MV1& c =
          *new (p) Pds::Epix::Config10ka2MV1( evr, 0, elemCfg );
        }
      public:
...
using namespace Pds_ConfigDb::V1::Epix10ka2M;
...
int ConfigTable::pull(const Pds::Epix::Config10ka2MV1& tc) {
  _globalP->pull(tc);
  for(unsigned q=0; q<4; q++)
...
int ConfigTable::push(void* to) const {
  ...
  Pds::Epix::Config10ka2MV1& tc = *reinterpret_cast<Pds::Epix::Config10ka2MV1*>(to);
  _globalP->push(&tc);
  for(unsigned q=0; q<4; q++)
    _quadP[q]->push(&const_cast<Epix10kaQuadConfigV1&>(tc.quad(q)));
  return tc._sizeof();
}

int ConfigTable::dataSize() const {
  return sizeof(Pds::Epix::Config10ka2MV1);
}
...
Pds_ConfigDb::V1::Epix10ka2MConfig::Epix10ka2MConfig():
...
int Pds_ConfigDb::V1::Epix10ka2MConfig::readParameters(void *from)
{
  return _table->pull(*reinterpret_cast<const Pds::Epix::Config10ka2MV1*>(from));
}

int Pds_ConfigDb::V1::Epix10ka2MConfig::writeParameters(void *to)
{
  return _table->push(to);
}

int Pds_ConfigDb::V1::Epix10ka2MConfig::dataSize() const
{
  return _table->dataSize();
}

bool Pds_ConfigDb::V1::Epix10ka2MConfig::validate()
{
