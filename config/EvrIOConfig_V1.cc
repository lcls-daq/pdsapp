...
EvrIOConfig_V1::EvrIOConfig::EvrIOConfig():
...
int EvrIOConfig_V1::EvrIOConfig::readParameters(void *from)
{
  return _private_data->pull(from);
}

int EvrIOConfig_V1::EvrIOConfig::writeParameters(void *to)
{
  return _private_data->push(to);
}

int EvrIOConfig_V1::EvrIOConfig::dataSize() const
{
  return _private_data->dataSize();
}


EvrIOConfig_V1::EvrIOConfigQ::EvrIOConfigQ(EvrIOConfig::Private_Data& c,
					   QWidget* w) : QObject(w), _c(c) {}

void EvrIOConfig_V1::EvrIOConfigQ::addEvr() { _c.addEvr(); }

void EvrIOConfig_V1::EvrIOConfigQ::remEvr() { _c.remEvr(); }
