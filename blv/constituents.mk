...
commonslib := $(USRLIBDIR)/rt offlinedb/mysqlclient
...
tgtlibs_evrblv += evgr/evr evgr/evg offlinedb/mysqlclient 
...
tgtlibs_pimblv += pds/camera pds/configdata offlinedb/mysqlclient
...
tgtlibs_pimblvedt += pds/camera offlinedb/mysqlclient
...
tgtlibs_evrbld += evgr/evr evgr/evg offlinedb/mysqlclient
...
tgtlibs_acqbld += pdsapp/configdb offlinedb/mysqlclient
...
tgtlibs_ipmbld += pdsapp/configdb offlinedb/mysqlclient
...
tgtlibs_ipmbldsim += pdsapp/configdb offlinedb/mysqlclient
...
tgtlibs_pimbld += pdsapp/configdb offlinedb/mysqlclient
...
tgtlibs_cambld += pdsapp/configdb offlinedb/mysqlclient
...
tgtlibs_pimbldedt += pdsapp/configdb offlinedb/mysqlclient
...
tgtlibs_netfifo := pds/service pdsdata/xtcdata offlinedb/mysqlclient
tgtslib_netfifo := $(USRLIBDIR)/rt

tgtsrcs_netfwd := netfwd.cc
tgtlibs_netfwd := pds/service pds/utility pds/collection pds/vmon pds/mon pds/xtc pdsdata/xtcdata offlinedb/mysqlclient
