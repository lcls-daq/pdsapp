...
typedef Pds::Epix::Config10kaV1       EpixConfig;
typedef Pds::Epix::ElementV3          EpixData;

using namespace Pds;

Epix10kaProcessor::Epix10kaProcessor() :
  _rows(352), _columns(384), _bitdepth(14), _offset(32),
  _srcInfo(0,DetInfo::CxiEndstation,0,DetInfo::Epix10ka,0),
  _cfgb(0)
{}
  
Epix10kaProcessor::~Epix10kaProcessor() { if (_cfgb) delete[] _cfgb; }

Dgram* Epix10kaProcessor::configure(Dgram*         dg) {
  ...
  EpixConfig& cfg = *new((char*)src->next())   
    EpixConfig(-1, // arg__version, 
               ...
               176, // arg__numberOfRowsPerAsic, 
               176, // arg__numberOfReadableRowsPerAsic, 
               192, // arg__numberOfPixelsPerAsicRow, 
...
Dgram* Epix10kaProcessor::event(Dgram*      dg,
                                const char* source) {
