...
tgtlibs_camrecord := $(commonlibs) epics/ca epics/Com pds/service szip/sz hdf5/hdf5
tgtlibs_camrecord += pds/logbookclient python3/python3.6m

tgtincs_camrecord := epics/include epics/include/os/Linux pdsdata/include ndarray/include boost/include hdf5/include python3/include/python3.6m
